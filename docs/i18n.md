...
description: weewx-skyfield i18n — translating the Sky page through WeeWX lang files and [Texts], body names via $almanac.<body>.label, with per-string English fallback.
---
...
The complete reference dictionary, as shipped in 1.12 (`skins/Skyfield/lang/en.conf` in the
