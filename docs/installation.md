...
2. Download the latest release, `weewx-skyfield.zip`, from the
   ...
   It is a large download: the bundled DE421 ephemeris (17 MB) and the complete Hipparcos
   star catalog (15 MB gzipped) are most of it, with the documentation's screenshots
